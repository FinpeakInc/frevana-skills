...
Model:
  --model                deepseek/deepseek-v4.1-flash (default)
...
case "$MODEL" in
  deepseek/deepseek-v4.1-flash|deepseek-v4.1-flash|deepseek-4.1-flash)
    MODEL="deepseek/deepseek-v4.1-flash"
    ;;
  *)
    echo "Invalid model: $MODEL" >&2
    echo "Allowed model for this skill: deepseek/deepseek-v4.1-flash" >&2
    exit 1
    ;;
esac
