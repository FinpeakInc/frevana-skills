...
export BACKLINKS_API_NAME="Backlinks Bulk Ranks"
export BACKLINKS_API_METHOD="POST"
export BACKLINKS_API_PATH="/service/backlinks/bulk-ranks"
export BACKLINKS_ALLOWED_FIELDS="targets rank_scale tag"
export BACKLINKS_REQUIRED_FIELDS="targets"
export BACKLINKS_OUTPUT_PREFIX="backlinks-bulk-ranks"
