...
RESULT = b'[{"ok":true,"source":"tiktok-posts-discover-by-profile-url"}]'
...
class TikTokSkillTest(unittest.TestCase):
    ...
    def test_run_creates_polls_and_preserves_raw_result(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            result = self.run_script(
                ...
                "client-fixed",
                "--input-json",
                '{"url":"https://www.tiktok.com/@babyariel","num_of_posts":2,"post_type":"Video Posts","country":"us"}',
                "--output",
                str(output),
            )
        ...
        self.assertEqual(
            ...
            [
                ("POST", "/service/tiktok/posts/discover-by-profile-url"),
        ...
        self.assertEqual(payload["input"], [{"url":"https://www.tiktok.com/@babyariel","num_of_posts":2,"post_type":"Video Posts","country":"US"}])
    ...
    def test_invalid_operation_input_is_rejected_before_network(self):
        result = self.run_script("create", "--input-json", '{"url":"https://www.tiktok.com/@babyariel/video/123"}')
        self.assertNotEqual(result.returncode, 0)
        self.assertIn("valid HTTPS TikTok profile URL", result.stderr.decode())
