...
export BACKLINKS_API_NAME="Backlinks Bulk Spam Score"
export BACKLINKS_API_METHOD="POST"
export BACKLINKS_API_PATH="/service/backlinks/bulk-spam-score"
export BACKLINKS_ALLOWED_FIELDS="targets tag"
export BACKLINKS_REQUIRED_FIELDS="targets"
export BACKLINKS_OUTPUT_PREFIX="backlinks-bulk-spam-score"
