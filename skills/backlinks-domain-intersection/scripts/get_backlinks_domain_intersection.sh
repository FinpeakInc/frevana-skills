...
export BACKLINKS_API_NAME="Backlinks Domain Intersection"
export BACKLINKS_API_METHOD="POST"
export BACKLINKS_API_PATH="/service/backlinks/domain-intersection"
export BACKLINKS_ALLOWED_FIELDS="targets exclude_targets filters order_by offset limit internal_list_limit backlinks_status_type backlinks_filters include_subdomains include_indirect_links exclude_internal_backlinks intersection_mode rank_scale tag"
export BACKLINKS_REQUIRED_FIELDS="targets"
export BACKLINKS_OUTPUT_PREFIX="backlinks-domain-intersection"
