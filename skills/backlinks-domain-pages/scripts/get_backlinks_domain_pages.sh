...
export BACKLINKS_API_NAME="Backlinks Domain Pages"
export BACKLINKS_API_METHOD="POST"
export BACKLINKS_API_PATH="/service/backlinks/domain-pages"
export BACKLINKS_ALLOWED_FIELDS="target limit offset internal_list_limit backlinks_status_type filters order_by backlinks_filters include_subdomains exclude_internal_backlinks rank_scale tag"
