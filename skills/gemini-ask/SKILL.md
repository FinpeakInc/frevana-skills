---
name: gemini-ask
description: Use when the user wants to ask Gemini a question through Frevana using the user's logged-in Chrome session.
---

# Gemini Ask

Ask Gemini through the local Frevana daemon and Chrome session.

## Purpose

This skill is for **asking Gemini a prompt** using the Chrome-backed Frevana MCP tool `frevana_ask` with fixed provider `gemini`.
