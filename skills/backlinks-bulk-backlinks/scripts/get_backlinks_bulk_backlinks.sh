...
export BACKLINKS_API_NAME="Backlinks Bulk Backlinks"
export BACKLINKS_API_METHOD="POST"
export BACKLINKS_API_PATH="/service/backlinks/bulk-backlinks"
export BACKLINKS_ALLOWED_FIELDS="targets tag"
export BACKLINKS_REQUIRED_FIELDS="targets"
export BACKLINKS_OUTPUT_PREFIX="backlinks-bulk-backlinks"
