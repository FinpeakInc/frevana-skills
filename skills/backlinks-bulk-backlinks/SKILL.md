...
description: Use when the user wants external backlink/inbound-link count totals for many domains or URLs in one batch request.
---
...
- Default file path: `./out/backlinks-bulk-backlinks-<UTC timestamp>-<pid>.json`
