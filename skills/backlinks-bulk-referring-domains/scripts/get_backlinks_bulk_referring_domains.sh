...
export BACKLINKS_API_NAME="Backlinks Bulk Referring Domains"
export BACKLINKS_API_METHOD="POST"
export BACKLINKS_API_PATH="/service/backlinks/bulk-referring-domains"
export BACKLINKS_ALLOWED_FIELDS="targets tag"
export BACKLINKS_REQUIRED_FIELDS="targets"
export BACKLINKS_OUTPUT_PREFIX="backlinks-bulk-referring-domains"
