...
export BACKLINKS_API_NAME="Backlinks Competitors"
export BACKLINKS_API_METHOD="POST"
export BACKLINKS_API_PATH="/service/backlinks/competitors"
export BACKLINKS_ALLOWED_FIELDS="target limit offset filters order_by main_domain exclude_large_domains exclude_internal_backlinks rank_scale tag"
export BACKLINKS_REQUIRED_FIELDS="target"
export BACKLINKS_OUTPUT_PREFIX="backlinks-competitors"
