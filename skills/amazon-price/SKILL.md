---
name: amazon-price
description: Use when the user wants Amazon price, discount, or coupon information through Frevana using the Frevana Chrome Extension session and a full Amazon product URL.
---
