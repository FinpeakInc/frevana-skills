...
description: Use when the user explicitly wants to publish a post to Facebook through Frevana using the Frevana Chrome Extension session.
---
...
5. If publishing fails because Facebook is unavailable or not logged in, tell the user to log in to Facebook in Chrome.
