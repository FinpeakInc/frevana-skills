---
name: backlinks-timeseries-summary
description: Use when the user wants external backlink/inbound-link, referring-domain, or authority metrics grouped over time for one target and date range.
---
...
`target`, `date_from`, `date_to`, `group_range`, `include_subdomains`, `rank_scale`, `tag`
...
- Default file path: `./out/backlinks-timeseries-summary-<UTC timestamp>-<pid>.json`
