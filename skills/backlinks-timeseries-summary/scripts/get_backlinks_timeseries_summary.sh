...
export BACKLINKS_API_NAME="Backlinks Timeseries Summary"
export BACKLINKS_API_METHOD="POST"
export BACKLINKS_API_PATH="/service/backlinks/timeseries-summary"
export BACKLINKS_ALLOWED_FIELDS="target date_from date_to group_range include_subdomains rank_scale tag"
export BACKLINKS_REQUIRED_FIELDS="target"
export BACKLINKS_OUTPUT_PREFIX="backlinks-timeseries-summary"
