...
export BACKLINKS_API_NAME="Backlinks Index"
export BACKLINKS_API_METHOD="GET"
export BACKLINKS_API_PATH="/service/backlinks/index"
export BACKLINKS_ALLOWED_FIELDS=""
export BACKLINKS_REQUIRED_FIELDS=""
export BACKLINKS_OUTPUT_PREFIX="backlinks-index"
