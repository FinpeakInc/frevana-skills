...
export BACKLINKS_API_NAME="Backlinks Summary"
export BACKLINKS_API_METHOD="POST"
export BACKLINKS_API_PATH="/service/backlinks/summary"
export BACKLINKS_ALLOWED_FIELDS="target include_subdomains include_indirect_links exclude_internal_backlinks internal_list_limit backlinks_status_type backlinks_filters rank_scale tag"
export BACKLINKS_REQUIRED_FIELDS="target"
export BACKLINKS_OUTPUT_PREFIX="backlinks-summary"
