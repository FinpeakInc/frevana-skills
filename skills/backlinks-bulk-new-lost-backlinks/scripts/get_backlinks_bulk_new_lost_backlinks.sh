...
export BACKLINKS_API_NAME="Backlinks Bulk New Lost Backlinks"
export BACKLINKS_API_METHOD="POST"
export BACKLINKS_API_PATH="/service/backlinks/bulk-new-lost-backlinks"
export BACKLINKS_ALLOWED_FIELDS="targets date_from tag"
export BACKLINKS_REQUIRED_FIELDS="targets"
export BACKLINKS_OUTPUT_PREFIX="backlinks-bulk-new-lost-backlinks"
