---
name: deepseek-ask
description: Use when the user wants to ask DeepSeek a question through Frevana using the user's logged-in Chrome session.
---

# DeepSeek Ask

Ask DeepSeek through the local Frevana daemon and Chrome session.

## Purpose

This skill is for **asking DeepSeek a prompt** using the Chrome-backed Frevana MCP tool `frevana_ask` with fixed provider `deepseek`.
