...
ALLOWED_MODELS=("bytedance/seedance-2.0" "bytedance/seedance-2.0-fast" "bytedance/seedance-2.0-mini")
ALLOWED_RESOLUTIONS=("480p" "720p" "1080p" "4K")
ALLOWED_ASPECT_RATIOS=("1:1" "3:4" "9:16" "4:3" "16:9" "21:9" "9:21")
...
if [[ "$MODEL" == "bytedance/seedance-2.0-fast" || "$MODEL" == "bytedance/seedance-2.0-mini" ]]; then
...
if watermark == "true":
    payload.setdefault("provider", {}).setdefault("options", {}).setdefault("byteplus", {})["watermark"] = True
elif watermark == "false":
    payload.setdefault("provider", {}).setdefault("options", {}).setdefault("byteplus", {})["watermark"] = False
