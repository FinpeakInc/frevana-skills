...
export BACKLINKS_API_NAME="Backlinks Referring Domains"
export BACKLINKS_API_METHOD="POST"
export BACKLINKS_API_PATH="/service/backlinks/referring-domains"
...
export BACKLINKS_OUTPUT_PREFIX="backlinks-referring-domains"
