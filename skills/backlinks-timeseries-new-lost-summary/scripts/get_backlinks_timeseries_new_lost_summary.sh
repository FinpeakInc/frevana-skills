...
export BACKLINKS_API_NAME="Backlinks Timeseries New Lost Summary"
export BACKLINKS_API_METHOD="POST"
export BACKLINKS_API_PATH="/service/backlinks/timeseries-new-lost-summary"
export BACKLINKS_ALLOWED_FIELDS="target date_from date_to group_range include_subdomains tag"
