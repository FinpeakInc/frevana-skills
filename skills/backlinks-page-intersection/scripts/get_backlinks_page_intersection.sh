...
export BACKLINKS_API_NAME="Backlinks Page Intersection"
export BACKLINKS_API_METHOD="POST"
export BACKLINKS_API_PATH="/service/backlinks/page-intersection"
export BACKLINKS_ALLOWED_FIELDS="targets exclude_targets backlinks_status_type filters order_by offset limit internal_list_limit include_subdomains include_indirect_links exclude_internal_backlinks intersection_mode rank_scale tag"
export BACKLINKS_REQUIRED_FIELDS="targets"
export BACKLINKS_OUTPUT_PREFIX="backlinks-page-intersection"
