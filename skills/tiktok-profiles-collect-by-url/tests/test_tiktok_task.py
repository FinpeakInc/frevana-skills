...
RESULT = b'[{"ok":true,"source":"tiktok-profiles-collect-by-url"}]'
...
class TikTokSkillTest(unittest.TestCase):
    ...
    def test_run_creates_polls_and_preserves_raw_result(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            result = self.run_script(
                ...
                "client-fixed",
                "--input-json",
                '{"url":"https://www.tiktok.com/@fofimdmell","country":"us"}',
                "--output",
                str(output),
            )
        ...
        self.assertEqual(
            ...
            [
                ("POST", "/service/tiktok/profiles/collect-by-url"),
        ...
        self.assertEqual(payload["input"], [{"url":"https://www.tiktok.com/@fofimdmell","country":"US"}])
    ...
    def test_invalid_operation_input_is_rejected_before_network(self):
        result = self.run_script("create", "--input-json", '{"url":"https://example.com/@fofimdmell"}')
        self.assertNotEqual(result.returncode, 0)
