---
name: tiktok-profiles-collect-by-url
description: Collect public TikTok creator, account, or profile details and metadata from one or more exact TikTok profile or homepage URLs through Frevana, and continue status or result retrieval for tasks created by this operation. Use when profile links and profile data are requested; do not use for post discovery, post collection, or TikTok Ads management.
---

# TikTok Profiles Collect by URL

Use this skill to collect public profile records from one or more exact TikTok profile URLs. The bundled script owns the complete create, poll, and raw-result flow.
...
bash {baseDir}/scripts/tiktok_task.sh run \
  --input-json '{"url":"https://www.tiktok.com/@fofimdmell","country":"US"}'
...
- This skill fixes creation to `POST /service/tiktok/profiles/collect-by-url`; do not route another TikTok operation through it.
