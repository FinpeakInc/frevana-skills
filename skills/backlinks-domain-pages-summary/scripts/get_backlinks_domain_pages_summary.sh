...
export BACKLINKS_API_NAME="Backlinks Domain Pages Summary"
export BACKLINKS_API_METHOD="POST"
export BACKLINKS_API_PATH="/service/backlinks/domain-pages-summary"
export BACKLINKS_ALLOWED_FIELDS="target limit offset internal_list_limit backlinks_status_type filters order_by backlinks_filters include_subdomains include_indirect_links exclude_internal_backlinks rank_scale tag"
export BACKLINKS_REQUIRED_FIELDS="target"
export BACKLINKS_OUTPUT_PREFIX="backlinks-domain-pages-summary"
