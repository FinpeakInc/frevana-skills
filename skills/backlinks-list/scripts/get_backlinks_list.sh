...
export BACKLINKS_API_NAME="Backlinks List"
export BACKLINKS_API_METHOD="POST"
export BACKLINKS_API_PATH="/service/backlinks/backlinks"
export BACKLINKS_ALLOWED_FIELDS="target mode custom_mode filters order_by offset search_after_token limit backlinks_status_type include_subdomains include_indirect_links exclude_internal_backlinks rank_scale tag"
export BACKLINKS_REQUIRED_FIELDS="target"
export BACKLINKS_OUTPUT_PREFIX="backlinks-list"
