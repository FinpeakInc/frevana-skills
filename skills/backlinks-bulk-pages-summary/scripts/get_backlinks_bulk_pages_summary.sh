...
export BACKLINKS_API_NAME="Backlinks Bulk Pages Summary"
export BACKLINKS_API_METHOD="POST"
export BACKLINKS_API_PATH="/service/backlinks/bulk-pages-summary"
export BACKLINKS_ALLOWED_FIELDS="targets include_subdomains rank_scale tag"
export BACKLINKS_REQUIRED_FIELDS="targets"
export BACKLINKS_OUTPUT_PREFIX="backlinks-bulk-pages-summary"
