...
export BACKLINKS_API_NAME="Backlinks History"
export BACKLINKS_API_METHOD="POST"
export BACKLINKS_API_PATH="/service/backlinks/history"
export BACKLINKS_ALLOWED_FIELDS="target date_from date_to rank_scale tag"
export BACKLINKS_REQUIRED_FIELDS="target"
export BACKLINKS_OUTPUT_PREFIX="backlinks-history"
