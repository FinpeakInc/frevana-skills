---
name: doubao-ask
description: Use when the user wants to ask Doubao a question through Frevana using the user's logged-in Chrome session.
---

# Doubao Ask

Ask Doubao through the local Frevana daemon and Chrome session.

## Purpose

This skill is for **asking Doubao a prompt** using the Chrome-backed Frevana MCP tool `frevana_ask` with fixed provider `doubao`.
